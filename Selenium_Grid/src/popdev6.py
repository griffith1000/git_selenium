...
class Griffith1Population(unittest.TestCase):
    def setUp(self):
        ...
        self.base_url = "http://dj.beatportdev.com/"
...
#____________________________________________Setting up 5 random genres 
        ...
        #for number in genre:
            ...
            driver.get("http://sushi.beatportdev.com/genre/breaks/"+str(randomgenre)+"/tracks?perPage=150&sortBy=publishDate+DESC%2C+releaseId+DESC&page="+str(genrepage)+"") 
