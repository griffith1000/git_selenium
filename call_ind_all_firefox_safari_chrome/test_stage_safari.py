...
#self.driver = webdriver.Firefox()
    ...
    def generateData(self):
            ...
            self.driver.get("http://stage-dj.beatport.com/1969629")
...
#_________________________    Assertion pf Beatport DJ's ... If it doesnt' see that it fails
            self.assertIn("Beatport DJs", driver.title)
