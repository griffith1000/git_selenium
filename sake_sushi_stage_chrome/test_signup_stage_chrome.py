...
class DJHelpers(unittest.TestCase):
    ...
    def generateData(self):
            ...
            self.random1 = random.randrange(1000,10000,1);
...
#            #time.sleep()
            driver.get("https://accounts.beatportdev.com/register?startCheckout=0&sourceType=dj&referrer=http%3A%2F%2Fdj.beatportdev.com")
            ...
            driver.find_element_by_id("username").send_keys("djnoprofile3")
    ...
    def createProfile(self, djname, bio, random1, rndgenre1, rndgenre2, rndgenre3):
...
#_______________________End create Chart________Begin create event
    def addEvent(self, photo5, event):   
            ...
            self.driver.find_element_by_id("event_image").send_keys("/home/ian.griffith/Desktop/numbered_djs/dj" + str(self.photo5) + ".jpg")
...
#      
    ...
    def testFullRegression(self):
            self.registerDJ(self.djname, self.random1)
#            self.createProfile(self.djname, self.bio, self.random1, self.rndgenre1, self.rndgenre2, self.rndgenre3)
#            self.addVideo()
#            self.addSoundCloud()
